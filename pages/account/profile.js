    ...
    <Layout title="User Profile">
      <div className={styles.dash}>
        ...
        <form onSubmit={handleSubmit} className={styles2.form}>
          ...
          {disabled===false?<><button className="btn-edit" type="submit" onClick={handleSubmit}> 
            Save Changes
          </button></>:<></>}
          
        </form>
        &nbsp; &nbsp; &nbsp;
        {disabled===false?<><button className="btn-edit" onClick={handleEnabled}>Cancel</button></>:<><button className="btn-edit" onClick={handledisabled}>Edit Profile</button></>}
